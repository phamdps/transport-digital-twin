...
class DecoderLayer(nn.Module):
    ...
    '''
    def __init__(self, seg_len, d_model, n_heads, d_ff=None, flash_attn=0, dropout=0.1, out_seg_num = 10, factor = 10):
        super(DecoderLayer, self).__init__()
        self.self_attention = TwoStageAttentionLayer(out_seg_num, factor, d_model, n_heads, \
                                d_ff, flash_attn, dropout)    
...
class Decoder(nn.Module):
    ...
    '''
    def __init__(self, seg_len, d_layers, d_model, n_heads, d_ff, flash_attn, dropout,\
        ...
        for i in range(d_layers):
            self.decode_layers.append(DecoderLayer(seg_len, d_model, n_heads, d_ff, flash_attn, dropout, \
                                        out_seg_num, factor))
